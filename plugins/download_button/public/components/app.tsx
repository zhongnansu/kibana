...
export const DownloadButtonApp = ({
  ...
  //   http.get('/api/download_button/example').then(res => {
  ...
  const downloadHandler = () => {
    ...
    http.post('/api/download_button/download',  {
      body: JSON.stringify({
        name: "kim"
      })
    }).then(res => {
            ...
            <EuiPageBody>
              <EuiPageHeader>
                <EuiTitle size="l">
                  <h1>
                    <FormattedMessage
                      id="downloadButton.helloWorldText"
                      defaultMessage="{name}"
              ...
              <EuiPageContent>
                <EuiPageContentHeader>
                  <EuiTitle>
                    <h2>
                      <FormattedMessage
                        id="downloadButton.congratulationsTitle"
                ...
                <EuiPageContentBody>
                  <EuiText>
                    ...
                    <p>
                      <FormattedMessage
                        id="downloadButton.timestampText"
